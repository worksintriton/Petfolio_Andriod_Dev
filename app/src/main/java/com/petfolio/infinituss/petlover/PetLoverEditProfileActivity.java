...
import com.petfolio.infinituss.requestpojo.EmailOTPRequest;
import com.petfolio.infinituss.requestpojo.ProfileUpdateRequest;
import com.petfolio.infinituss.responsepojo.EmailOTPResponse;
import com.petfolio.infinituss.responsepojo.ProfileUpdateResponse;
            ...
            public void onResponse(@NonNull Call<EmailOTPResponse> call, @NonNull Response<EmailOTPResponse> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (200 == response.body().getCode()) {
                        Toasty.success(getApplicationContext(),response.body().getMessage(), Toast.LENGTH_SHORT, true).show();
                        if(response.body().getData() != null) {
                            Intent intent = new Intent(PetLoverEditProfileActivity.this, PetVerifyEmailOtpActivity.class);
