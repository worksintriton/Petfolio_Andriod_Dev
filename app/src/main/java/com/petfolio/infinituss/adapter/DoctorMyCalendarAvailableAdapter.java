...
import com.petfolio.infinituss.doctor.DoctorMyCalendarActivity;
import com.petfolio.infinituss.doctor.DoctorMyCalendarTimeActivity;
import com.petfolio.infinituss.interfaces.OnItemClickSpecialization;
import com.petfolio.infinituss.responsepojo.DoctorMyCalendarAvlDaysResponse;

import java.util.ArrayList;
import java.util.List;


public class DoctorMyCalendarAvailableAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "DoctorMyCalendarAvailableAdapter";
