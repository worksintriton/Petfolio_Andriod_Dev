...
import com.petfolio.infinituss.petlover.PetAppointment_SlotNotAvailable_Doctor_Date_Time_Activity;
import com.petfolio.infinituss.responsepojo.PetDoctorAvailableTimeResponse;
...
public class PetMyCalendarSlotNotAvailableAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "petMyCalendarSlotNotAvailableAdapter";
    ...
    public PetMyCalendarSlotNotAvailableAdapter(Context context, List<PetDoctorAvailableTimeResponse.DataBean.TimesBean> timesBeanList, RecyclerView inbox_list, PetAppointment_SlotNotAvailable_Doctor_Date_Time_Activity petAppointment_slotNotAvailable_doctor_date_time_activity) {
        this.timesBeanList = timesBeanList;
        this.context = context;
        this.mCallback = (OnItemSelectedTime)petAppointment_slotNotAvailable_doctor_date_time_activity;
