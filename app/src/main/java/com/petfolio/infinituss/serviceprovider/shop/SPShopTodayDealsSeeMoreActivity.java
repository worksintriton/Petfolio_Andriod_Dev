...
public class SPShopTodayDealsSeeMoreActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /* @SuppressLint("NonConstantResourceId")
    ...
    private void showSortByAlert() {
        try {
            dialog = new Dialog(SPShopTodayDealsSeeMoreActivity.this);
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(SPShopTodayDealsSeeMoreActivity.this, ServiceProviderDashboardActivity.class);
