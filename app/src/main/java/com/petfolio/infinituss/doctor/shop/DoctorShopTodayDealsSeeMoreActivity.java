package com.petfolio.infinituss.doctor.shop;
...
import com.petfolio.infinituss.adapter.PetShopTodayDealsSeeMoreAdapter;
import com.petfolio.infinituss.adapter.ProductsSearchAdapter;
...
import com.petfolio.infinituss.requestpojo.TodayDealMoreRequest;
import com.petfolio.infinituss.responsepojo.ProductSearchResponse;
import com.petfolio.infinituss.responsepojo.TodayDealMoreResponse;
...
public class DoctorShopTodayDealsSeeMoreActivity extends AppCompatActivity implements View.OnClickListener {

    private String TAG = "DoctorShopTodayDealsSeeMoreActivity";
    ...
    private void showSortByAlert() {
        try {
            dialog = new Dialog(DoctorShopTodayDealsSeeMoreActivity.this);
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(DoctorShopTodayDealsSeeMoreActivity.this, DoctorDashboardActivity.class);
