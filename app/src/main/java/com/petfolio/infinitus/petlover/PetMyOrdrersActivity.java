...
import com.petfolio.infinitus.fragmentpetlover.myorders.FragmentPetCurrentOrders;
...
public class PetMyOrdrersActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentPetCurrentOrders(), "New");
        adapter.addFragment(new FragmentPetCompletedOrders(), "Completed");
         adapter.addFragment(new FragmentPetCancelledOrders(), "Missed");
