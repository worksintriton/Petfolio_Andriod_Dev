...
public class VideoCallPetLoverActivity extends AppCompatActivity implements JitsiMeetActivityInterface, JitsiMeetViewListener {
    ...
    private Button btncloseconversation,btn_patientnoshow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backRela = findViewById(R.id.back_rela);
        backRela.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btncloseconversation = findViewById(R.id.btn_closeconversation);
        btn_patientnoshow = findViewById(R.id.btn_patientnoshow);
        btn_patientnoshow.setVisibility(View.GONE);


        btncloseconversation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
