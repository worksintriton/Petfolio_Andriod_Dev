...
import com.petfolio.infinitus.requestpojo.CouponCodeCheckRequest;
import com.petfolio.infinitus.requestpojo.FetchByIdRequest;
import com.petfolio.infinitus.requestpojo.NotificationCartCountRequest;
...
import com.petfolio.infinitus.responsepojo.CouponCodeCheckResponse;
import com.petfolio.infinitus.responsepojo.NotificationCartCountResponse;
    ...
    public void addandRemoveProductListener(String id, String name,String threshould,int prodcutcount) {
        if(name != null){
            if(name.equalsIgnoreCase("add")){
                ...
                if(productid != null){
                    if(prodcutcount != 0) {
                       // showremove_product_ResponseCall();
                        if (new ConnectionDetector(getApplicationContext()).isNetworkAvailable(getApplicationContext())) {
