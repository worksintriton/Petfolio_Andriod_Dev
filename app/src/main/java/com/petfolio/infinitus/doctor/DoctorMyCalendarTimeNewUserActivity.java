...
import com.petfolio.infinitus.adapter.DoctorMyCalendarTimeAvailableNewUserAdapter;
...
public class DoctorMyCalendarTimeNewUserActivity extends AppCompatActivity implements OnItemClickSpecialization {
    private static final String TAG = "DoctorMyCalendarTimeNewUserActivity" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new ConnectionDetector(DoctorMyCalendarTimeNewUserActivity.this).isNetworkAvailable(DoctorMyCalendarTimeNewUserActivity.this)) {
    ...
    private void setViewAvlTimes() {
        ...
        DoctorMyCalendarTimeAvailableNewUserAdapter doctorMyCalendarAvailableAdapter = new DoctorMyCalendarTimeAvailableNewUserAdapter(getApplicationContext(), dataBeanList, rv_doctor_mycalendar_avldays, DoctorMyCalendarTimeNewUserActivity.this);
            ...
            public void onResponse(@NonNull Call<DoctorMyCalendarUpdateDocDateResponse> call, @NonNull Response<DoctorMyCalendarUpdateDocDateResponse> response) {
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        startActivity(new Intent(DoctorMyCalendarTimeNewUserActivity.this, DoctorDashboardActivity.class));
