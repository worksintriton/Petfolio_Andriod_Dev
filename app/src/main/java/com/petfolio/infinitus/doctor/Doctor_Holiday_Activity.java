...
import com.petfolio.infinitus.adapter.DoctorHolidayListAdapter;
...
public class Doctor_Holiday_Activity extends AppCompatActivity implements OnItemDeleteHoliday {
    ...
    DoctorHolidayListAdapter doctorHolidayListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // userid = user.get(SessionManager.KEY_ID);
        ...
        if (new ConnectionDetector(Doctor_Holiday_Activity.this).isNetworkAvailable(Doctor_Holiday_Activity.this)) {
    ...
    private void setView() {
        ...
        doctorHolidayListAdapter = new DoctorHolidayListAdapter(getApplicationContext(), holidayListResponseList, rv_listofholidays,this);
        rv_listofholidays.setAdapter(doctorHolidayListAdapter);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getApplicationContext(),DoctorMyCalendarActivity.class));
        finish();
    }
    ...
    private void showStatusAlert(String dateid) {
        ...
        try {
            ...
            dialog = new Dialog(Doctor_Holiday_Activity.this);
    ...
    private void holidayDeleteResponseCall(final ProgressDialog dialog, String dateid) {
        ...
        Call<HolidayDeleteResponse> call = apiInterface.holidayDeleteResponseCall(RestUtils.getContentType(),holidayDeleteRequest(dateid));
