            ...
            //    Toasty.success(getApplicationContext(),"NotificationUpdateResponse : "+new Gson().toJson(response.body()), Toast.LENGTH_SHORT, true).show();
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        SessionManager sessionManager = new SessionManager(VerifyEmailOtpActivity.this);
                        ...
                        if(fromactivity != null && fromactivity.equalsIgnoreCase("LoginActivity")){
                            if(usertype != 0){
                                if(usertype == 1){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, PetLoverDashboardActivity.class));

                                }else if(usertype == 2 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, ServiceProviderDashboardActivity.class));

                                }else if(usertype == 3 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, VendorDashboardActivity.class));

                                }else if(usertype == 4 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, DoctorDashboardActivity.class));
                            ...
                            if(usertype != 0){
                                if(usertype == 1 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, AddYourPetActivity.class));

                                }else if(usertype == 2 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, ServiceProviderRegisterFormActivity.class));

                                }else if(usertype == 3 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, VenderRegisterFormActivity.class));

                                }else if(usertype == 4 ){
                                    startActivity(new Intent(VerifyEmailOtpActivity.this, DoctorBusinessInfoActivity.class));
