...
public class SPCartActivity extends AppCompatActivity implements AddandRemoveProductListener, PaymentResultListener, BottomNavigationView.OnNavigationItemSelectedListener {
